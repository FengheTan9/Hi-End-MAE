...
import random
import numpy as np
from trainer import DenseMAETrainer
...
parser.add_argument('--model', type=str, default="dense_mae_vit_large_16p", choices=["dense_mae_vit_large_12p", "dense_mae_vit_base_16p", "dense_mae_vit_large_16p"], help='model')
...
parser.add_argument('--ckpt_dir', type=str, default="./ckpt/dense_mae_vit_large_12p")
